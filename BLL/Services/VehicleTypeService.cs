...
namespace AutoWashPro.BLL.Services
{
    public class VehicleTypeService : IVehicleTypeService
    {
        ...
        public async Task<bool> UpdateAsync(int id, CreateVehicleTypeDTO request)
        {
            ...
            if (typeExists) throw new BadRequestException("Vehicle type name is already taken.");
        ...
        public async Task<bool> DeleteAsync(int id)
        {
            ...
            if (type.Vehicles.Any()) throw new BadRequestException("Cannot delete this vehicle type because it is currently in use by customers' vehicles.");
