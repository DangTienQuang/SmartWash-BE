...
namespace AutoWashPro.API.Controllers
{
    ...
    public class CarModelsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateCarModel([FromBody] CreateCarModelDTO request)
        {
            ...
            if (!result)
                return BadRequest(new { statusCode = 400, message = "Failed to add car model!" });
        ...
        public async Task<IActionResult> DeleteCarModel(int id)
        {
            ...
            return Ok(new { statusCode = 200, message = "Car model hidden from system." });
        }
        ...
        public async Task<IActionResult> RequestNewCarModel([FromBody] RequestCarModelDTO request)
        {
            ...
            return Ok(new { statusCode = 200, message = "Car model request sent and pending approval.", data = newId });
        }
