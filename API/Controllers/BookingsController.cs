...
namespace AutoWashPro.API.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        private int GetUserId()
        {
            ...
            {
                throw new AutoWashPro.BLL.Exceptions.UnauthorizedException("Authentication information (UserId) not found. Please log in again.");
            }
            return userId;
        }
        ...
        public IActionResult TriggerConfirmationEmail(int bookingId)
        {
            ...
            return Accepted(new { 
                statusCode = 202, 
                message = "The system is processing and sending the confirmation email." 
            });
        }
        ...
        public async Task<IActionResult> CreateBooking([FromBody] CreateBookingDTO request)
        {
            ...
            var message = string.Equals(request.PaymentMethod, "PayOS", StringComparison.OrdinalIgnoreCase)
                ...
                ? "Booking successful. Please generate a QR code for payment."
                : "Booking and wallet payment successful.";
        ...
        public async Task<IActionResult> CreateBookingPaymentLink(int id, [FromBody] CreateBookingPaymentLinkDTO request)
        {
            ...
            return Ok(new { statusCode = 200, message = "Booking payment QR code generated successfully.", data = result });
        }
